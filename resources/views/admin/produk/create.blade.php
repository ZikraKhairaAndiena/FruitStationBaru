...
<form action="/produk" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('produk_id') is-invalid @enderror"
        name="produk_id" id="produk_id" value="{{ old('produk_id') }}">
        @error('produk_id')
      ...
      <div class="mb-3">
        ...
        name="satuan" id="satuan" value="{{ old('satuan') }}">
        @error('satuan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
      ...
      <div class="mb-3">
        ...
        name="harga_produk" id="harga_produk" value="{{ old('harga_produk') }}">
        @error('harga_produk')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
      ...
      <div class="mb-3">
        ...
        name="deskripsi_produk" id="deskripsi_produk" value="{{ old('deskripsi_produk') }}">
